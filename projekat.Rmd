...
```{r deskriptivna-statistika, eval=FALSE, include=FALSE}
conf <- spark_config()
conf$`sparklyr.shell.driver-memory` <- "12G"
conf$spark.memory.fraction <- 0.9
...
<iframe src="assets/descriptive_statistics_matrix.html" style="margin: 0 auto; display: block;" width="515px" height="230px"></iframe>

### Korelaciona matrica obelezja
...
```{r logisticka-regresija, echo=FALE, include=TRUE, eval=FALSE}
conf <- spark_config()
conf$`sparklyr.shell.driver-memory` <- "12G"
conf$spark.memory.fraction <- 0.9
